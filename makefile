...
test : load_file.o edit_file.o error_format.o command_tree.o
	$(CC) -g3 test.c bin/simple_str.o bin/load_file.o bin/edit_file.o bin/command_tree.o bin/error_format.o bin/div_str.o -o test -L$(Data_Structures_Path) -ldynamic_array -llinked_list
