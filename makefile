...
test : load_file.o edit_file.o error_format.o command_tree.o commands.o parse_commands.o parse_term_args.o
	$(CC) -g3 -o test test.c bin/simple_str.o bin/load_file.o bin/edit_file.o bin/command_tree.o bin/commands.o bin/parse_commands.o bin/parse_term_args.o bin/error_format.o bin/div_str.o -L$(Data_Structures_Path) -ldynamic_array -llinked_list -lhashmap
...
parse_term_args.o : hashmap
	$(CC) -g3 -c src/term_args/parse_term_args.c -o bin/parse_term_args.o
